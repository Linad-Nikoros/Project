...
<template>
	...
	<form v-if="isOpenForm" @submit="onSubmit" class="form">
		...
		<UiInput placeholder="Почта" v-model="customerEmail" v-bind="customerEmailAttrs" type="text" class="input" />
		<UiInput placeholder="Компания" v-model="customerName" v-bind="customerNameAttrs" type="text" class="input" />
